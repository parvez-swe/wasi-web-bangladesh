...
export const Header = () => {
  return (
    <div className="absolute md:fixed w-80 md:w-full h-96 md:h-14 rounded bg-black opacity-90 text-white grid grid-cols-1 md:grid-cols-4 items-center drop-shadow-lg  ">
